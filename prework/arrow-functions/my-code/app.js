...
// it is use the value of this in their lexical scope (it shows all the variables to a function where it is defined, and it show things is already called and the other things who didnt already called and how it is defined).
// 3. Explain why "this" is different when an arrow function is used.
// because it shows all the variables visible to a function where it is defined, and it shows things is already called and the other things who didint called and how they are defined.
